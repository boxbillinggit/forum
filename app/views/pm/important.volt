<div class="container">
    ...
    <div class="row">
        <div class="col-sm-3 col-md-2">
            <ul class="nav nav-pills nav-stacked">
                ...
                <li class="active"><a href="/pm/important">Important</a></li>
 ...
 <span class="glyphicon glyphicon-star-empty"></span><span class="name  label label-success" style="min-width: 120px; display: inline-block;">{{ pms.name }}</span> <span class="">{{ pms.subject }}</span>
